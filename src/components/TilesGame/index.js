...
const iconsList=[
    {
        id:1,category:"flower",imgUrl:"https://img.hotimg.com/flower-pictures.jpeg"

    },
    {
        id:2,category:"gift",imgUrl:"https://img.hotimg.com/istockphoto-1324002233-1024x1024.jpeg"
    }
]   
...
class TilesGame extends Component{
    state={score:0,
                ...
                <div className="name-display-container">
                    ...
                    <div className="tiles-container">
                        {initialTilesList.map(eachItem=>(
                            <TileItem key={eachItem.id} details={eachItem} onRevealButtons={this.onRevealButtons}/>
                        ))}
                    </div>
                </div>
            </div>
